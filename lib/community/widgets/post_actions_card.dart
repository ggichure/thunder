...
class PostActionsCard extends StatefulWidget {
  ...
  @override
  State<PostActionsCard> createState() => _PostActionsCardState();
}

class _PostActionsCardState extends State<PostActionsCard> {
